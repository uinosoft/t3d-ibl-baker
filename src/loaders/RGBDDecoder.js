...
export class RGBDDecoder {
	...
	/**
	 * Decode RGBD cube texture to linear color space.
	 ...
	 * @return {TextureCube|Null} The target cube texture, this is a render texture, so you can't get the data from the mipmaps attribute
	 */
